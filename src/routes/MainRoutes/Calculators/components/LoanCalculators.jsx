...
export const calculators = [
  ...
  },
  {
    ...
    description: "Calculate the required FD interest rate to pay loan EMIs through SWP without breaking your FD",
    linkText: "Check Now",
    icon: <Banknote className="w-10 h-10 text-black" />,
  },
  // {
  ...
  // },
  {
  ...
  },
   {
    ...
    title: "Home Loan Prepay",
    description: "Calculate how much you can save by prepaying your home loan",
    linkText: "Try Now",
    icon: <FileText className="w-10 h-10 text-black" />,
  },
  ...
  //   linkText: "Try Now",
  //   icon: <BarChart2 className="w-10 h-10 text-black" />,
  // },
  {
    slug: "emi-vs-rent",
    title: "EMI vs RENT",
  ...
  },
  {
    ...
    description: "Compare taking a loan against mutual funds versus using SWP withdrawals.",
    linkText: "Analyze",
    icon: <LineChart className="w-10 h-10 text-black" />,
  },
  {
    slug: "loan-extra-repayment",
    title: "Loan Calculator with Extra Repayments",
    description: "Calculate the impact of making extra payments on your loan tenure and interest.",
    linkText: "Calculate",
    icon: <Activity className="w-10 h-10 text-black" />,
  },
    {
    slug: "emi-interest-loan-finder",
    title: "EMI Calculator - Interest Rate Finder",
    description: "Calculate your loan's annual interest rate in seconds",
    linkText: "Calculate",
    icon: <Activity className="w-10 h-10 text-black" />,
  },
      {
    slug: "home-loan-eligibility",
    title: "Home Loan EMI & Eligibility Calculator",
    description: "Plan your home loan with accurate EMI calculations and eligibility checks",
    linkText: "Calculate",
    icon: <Activity className="w-10 h-10 text-black" />,
  },
];
