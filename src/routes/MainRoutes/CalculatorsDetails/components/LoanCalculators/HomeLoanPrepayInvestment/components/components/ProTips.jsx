      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        <ul className="space-y-2">
          <li className="flex items-start">
            ...
            <span>
              <strong>Golden Rule:</strong> If the loan interest rate is higher than
              your post-tax investment returns, prepaying the loan is usually the
              smarter choice.
            </span>
          </li>
          ...
          <li className="flex items-start">
            <span className="mr-2 mt-1 font-bold text-gray-700">✓</span>
            <span>
              <strong>Maximize Savings:</strong> When prepaying, reducing loan tenure
              almost always saves more interest than reducing EMI.
            </span>
          </li>
        </ul>
      </div>
