...
const InterestRatesFeesSection = ({ interestRatesFees }) => {
  if (!interestRatesFees) return null;
    ...
    <section className="mx-auto rounded-2xl my-10">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-200 rounded-lg">
          ...
          <tbody>
            {interestRatesFees.table.map((item, index) => (
              <tr
                key={index}
...
export default InterestRatesFeesSection;
