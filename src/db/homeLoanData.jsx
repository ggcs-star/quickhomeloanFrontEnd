export const homeLoanData = [
  {
    ...
    heroSection: {
      ...
      description:
        "Flexible EMI options starting at ₹820 per ₹1 lakh. With you, right through.",
    buttons: [
    {
  ...
  loanTypes: [
    ...
    contactSupport: {
      ...
      phone: { title: "Phone", number: "1800-210-4332" },
...
heroSection: {
  ...
  loanTypes: [
    ...
    highlightsSection: {
      items: [
        { icon: "percent", label: "Interest Rate", value: "8.45% p.a." },
        { icon: "calendar-clock", label: "Max Tenure", value: "30 Years" },
    ...
    contactSupport: {
      ...
      phone: { title: "Phone", number: "022-2217-8600" },
...
heroSection: {
  ...
  description:
    "Attractive interest rates starting at ₹825 per ₹1 lakh. Simplified process with transparent terms.",
  buttons: [
    {
      label: "Apply Instantly",
  ...
  highlightsSection: {
    items: [
      { icon: "percent", label: "Interest Rate", value: "8.40% p.a." },
      { icon: "calendar-clock", label: "Max Tenure", value: "30 Years" },
  ...
  contactSupport: {
    ...
    phone: { title: "Phone", number: "1800-5700" },
    hours: { title: "Business Hours", details: "Mon-Fri: 10am - 5pm" },
    buttons: {
      talkToOfficer: "Talk to a Loan Officer",
      bookCallback: "Book a Callback",
...
heroSection: {
  ...
  description:
    "Get home loans starting at 8.50% p.a. with zero prepayment charges on floating rate loans. Quick approval and transparent process guaranteed.",
  buttons: [
    {
      label: "Apply Instantly",
  ...
  contactSupport: {
    ...
    phone: { title: "Phone", number: "1860-419-5555" },
...
heroSection: {
  ...
  contactSupport: {
    ...
    phone: { title: "Phone", number: "1800-202-6161" },
